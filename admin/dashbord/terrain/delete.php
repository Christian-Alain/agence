...
if(!empty($_POST)) 
{
    ...
    $statement = $acces->prepare("DELETE FROM terrain WHERE id = ?"); 
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                        <h3 class="text-danger"><strong>Supprimer un Terrain</strong></h3>
                        </div>
                        <form method="post" role="form" action="delete.php">
                            ...
                            <a class="btn btn-default" href="terrain_crud.php">Non</a>
                        </form>
                    </div>
                </main>
