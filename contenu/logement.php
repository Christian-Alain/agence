...
<body>
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="logement.php" class="dropdown-item">Logements</a>
                                <a href="terrain.php" class="dropdown-item">Terrains</a>
                            </div>
                        </div>
                        <a href="lotissement.php" class="nav-item nav-link">Lotissement</a>
                        <a href="conseil.php" class="nav-item nav-link">Conseils</a>
                        <a href="transaction.php" class="nav-item nav-link">Transactions</a>
        ...
        <div class="container py-5">
            <div class="row align-items-center py-4">
                <div class="col-md-6 text-center text-md-left">
                    <h1 class="mb-4 mb-md-0 text-dark text-uppercase">Logements</h1>
                </div>
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        <a class="btn btn-outline-primary" href="">Accueil</a>
                        <i class="fas fa-angle-double-right text-primary mx-2"></i>
                        <a class="btn btn-outline-primary disabled" href="">Logements</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5">
            ...
            <div class="d-flex flex-column align-items-center justify-content-center">
                <div class="p-3" style="max-width: 800px;">
                    <a href="project.html" class="btn btn-primary py-md-3 px-md-5 mt-2 mt-md-4">Voir plus</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Detail Start -->
    <div class="container-fluid pt-5 mb-5 mx-n3">
        <h3 class="mb-4 ml-3 section-title">Article Similaire</h3>
        <div class="owl-carousel service-carousel position-relative">
            <div class="card border-0 mx-3">
                <img class="card-img-top" src="../img/blog-1.jpg" alt="">
                <div class="card-body bg-light p-4">
                    <div class="d-flex align-items-center mb-3">
                        <h5 class="m-0 text-truncate">Diam amet eos at no eos</h5>
                    </div>
                    <p>Diam amet eos at no eos sit, amet rebum ipsum clita stet, diam sea est diam eos, sit vero stet justo</p>
                </div>
            </div>
